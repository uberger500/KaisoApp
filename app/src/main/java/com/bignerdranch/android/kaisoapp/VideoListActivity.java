...
/**
 * Created by urs on 1/16/16.
 */
@TargetApi(13)
public class VideoListActivity extends Activity implements OnFullscreenListener {
 ...
 //   private List<ParseObject> releaseList;
    ...
    private static final class PageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                thumbnail.initialize(YoutubeKey.DEVELOPER_KEY, thumbnailListener);
            } else {
                YouTubeThumbnailView thumbnail = (YouTubeThumbnailView) view.findViewById(R.id.thumbnail);
    ...
    public static final class VideoFragment extends YouTubePlayerFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            initialize(YoutubeKey.DEVELOPER_KEY, this);
        }
