...
public class ReleasePagerActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_CRIME_ID = "com.bignerdranch.android.kaisoapp.release_id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UUID releaseId = (UUID) getIntent().getSerializableExtra(EXTRA_CRIME_ID);

        mViewPager = (ViewPager) findViewById(R.id.activity_release_pager_view_pager);
